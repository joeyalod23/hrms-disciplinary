...
RUN echo '#!/bin/sh' > /entrypoint.sh && \
    ...
    echo '  rm -f /app/data/db/sitevigil.db-shm /app/data/db/sitevigil.db-wal' >> /entrypoint.sh && \
    ...
    echo '    rm -f /app/data/db/sitevigil.db /app/data/db/sitevigil.db-shm /app/data/db/sitevigil.db-wal' >> /entrypoint.sh && \
    echo '    cp /app/seed/sitevigil.db /app/data/db/sitevigil.db' >> /entrypoint.sh && \
